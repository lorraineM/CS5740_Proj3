Readme for NLP Project 3

how to run: corenlp.CoreNLPClient(annotators='tokenize ssplit parse lemma pos ner'.split()), TfidfVectorizer(), generateReplacedPart(), unigram_model.fit_transform(), parse_tree_NP(), generate_candidateAnswerSpans(), getBestAnswer()
